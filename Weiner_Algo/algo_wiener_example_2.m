...
% Training
% The training section iterates through the first 30 images of the dataset 
% and trains on the value of K(u,v) ,
% which is the ratio of the PSD of Noise to PSD of original image.

K_matrices=zeros(512,512,30);
for i=1:30
    img=im2double(imread(strcat('img_dataset/',int2str(i),'.gif')));
...
% We are adding Gaussian Noise and Blur to a given good image and restoring it with the wiener filter.
% Pass the path of the good image in the code and run the section.

% Reading the image in Grayscale
originalImage=im2double(imread('img_dataset/40.gif'));
